...
<main class="bg-gray-100 mt-16 mb-16">
  <section id="login" class="py-8 px-6">
    <div class="container mx-auto">
      ...
      <form class="max-w-lg mx-auto border border-gray-300 rounded-lg p-8" method="post" action="login.jsp">
        <div class="mb-4">
        ...
        <div class="flex justify-center items-center mt-6">
          <button type="submit" class="bg-gray-800 text-white hover:bg-white hover:text-black font-bold py-2 px-4 rounded">Login</button>
        </div>
