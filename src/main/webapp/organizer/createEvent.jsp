...
<div class="container mx-auto p-8">
        ...
        <form action="/event-form" method="post" class="bg-white shadow-md p-6 rounded-lg">
            ...
            <div class="mb-4">
                <label for="eventCategory" class="block text-gray-700 font-semibold mb-1">Event Category:</label>
                <select id="eventCategory" name="eventCategory" class="w-full border border-gray-400 p-2 rounded-md" required>
