  ...
  <div class="flex">
    ...
    <aside class="sidebar bg-gray-200 h-screen w-64 py-4">
      ...
      <ul class="sidebar-menu">
        <li>
          <a href="participantDashboard.jsp" class="block px-4 py-2 text-gray-800 hover:bg-gray-300 rounded-md shadow-sm">Dashboard</a>
        </li>
        <li>
          <a href="participantDashboard.jsp?page=events" class="block px-4 py-2 text-gray-800 hover:bg-gray-300 rounded-md shadow-sm">Events</a>
        </li>
        <li>
          <a href="participantDashboard.jsp?page=transactionsLog" class="block px-4 py-2 text-gray-800 hover:bg-gray-300 rounded-md shadow-sm">Transaction</a>
        </li>
      </ul>
    </aside>
